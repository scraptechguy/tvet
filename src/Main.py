...
def main():
    ...
    default_mesh = "src/sample_files/tri_file_octdecv_1.obj"
    ...
    vispy.scene.visuals.Text("'e' to hide edges", anchor_x='left', anchor_y='bottom', pos=(20, 20), font_size=10,
                        color='white', parent=canvas.scene)
    vispy.scene.visuals.Text("'f' to hide faces", anchor_x='left', anchor_y='bottom', pos=(20, 40), font_size=10,
                        color='white', parent=canvas.scene)
    vispy.scene.visuals.Text("'s' to change scattering", anchor_x='left', anchor_y='bottom', pos=(20, 60), font_size=10,
                        color='white', parent=canvas.scene)
    vispy.scene.visuals.Text("'q' to quit", anchor_x='left', anchor_y='bottom', pos=(20, 80), font_size=10,
                        color='white', parent=canvas.scene)
