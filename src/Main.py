...
vispy.scene.visuals.Text("'w' to hide mesh grid", anchor_x='left', pos=(20, 20), font_size=10,
                     color='white', parent=canvas.scene)
vispy.scene.visuals.Text("'f' to hide surface", anchor_x='left', pos=(20, 40), font_size=10,
                     color='white', parent=canvas.scene)
